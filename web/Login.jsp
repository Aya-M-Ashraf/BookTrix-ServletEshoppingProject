    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            html5rocks.webdb.open = function () {
                ...
                html5rocks.webdb.db = openDatabase("DB", "1", "Project", dbSize);
//                alert("open");
            };

            html5rocks.webdb.login = function (renderFunc) {
                var db = html5rocks.webdb.db;
                email = getEmail();
                password = getPassword();
                db.transaction(function (tx) {
                    tx.executeSql("SELECT email FROM user where email=? and password=?", [email, password],
    ...
    <body  onload="html5rocks.webdb.open()">  
        ...
        <div class="container">
            ...
            <section id="content">
                <form action="" method="POST">
                    ...
                    <div>
                        <input type="text" placeholder="text" required="" id="email"  name="email"/>
                    </div>
                    <div>
                    ...
                    <div>
                        <input type="submit" value="Login" onclick="html5rocks.webdb.login()" />
